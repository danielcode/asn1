...
typedef struct asn_TYPE_descriptor_s {
	...
	/*
	 * Pointer to type's implementor and parent
	 * Implementor is the type used to implement.
	 * Parent reflects the hierarchy from the ASN.1 module
	 */
	struct asn_TYPE_descriptor_s *implementor;
	struct asn_TYPE_descriptor_s *parent;
