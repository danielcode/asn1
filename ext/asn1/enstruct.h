...
extern void *enstruct_bitstring(VALUE v,		asn_TYPE_descriptor_t *td, void *container);
extern void *enstruct_iso646string(VALUE v,		asn_TYPE_descriptor_t *td, void *container);
